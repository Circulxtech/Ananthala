...
// Bliss product IDs: 15, 16, 17, 18
const blissProductIds = [15, 16, 17, 18]

export function CustomersAlsoBought({ currentProductId }: CustomersAlsoBoughtProps) {
  const router = useRouter()
  
  // Get all bliss products excluding the current one
  const relatedProducts = blissProductIds
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl sm:text-2xl text-foreground font-medium">
            Discover more from our Bliss collection
          </p>
        </div>
