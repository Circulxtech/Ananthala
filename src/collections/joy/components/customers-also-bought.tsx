...
// Joy product IDs: 7, 8, 9, 10, 11, 12, 13, 14
const joyProductIds = [7, 8, 9, 10, 11, 12, 13, 14]

export function CustomersAlsoBought({ currentProductId }: CustomersAlsoBoughtProps) {
  const router = useRouter()
  
  // Get all joy products excluding the current one
  const relatedProducts = joyProductIds
      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-xl sm:text-2xl text-foreground font-medium">
            Discover more from our Joy collection
          </p>
        </div>
