            ...
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="mb-3 text-xl font-bold transition-colors duration-300">{value.title}</h3>
      ...
      <section className="py-24 px-4 bg-[#F5F1ED]">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="mb-6 text-3xl font-bold text-black">Our Commitment to Sustainability</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="relative rounded-lg overflow-hidden shadow-sm min-h-[250px] group">
              ...
              <div className="relative z-10 p-8 h-full flex flex-col">
                <h3 className="text-xl font-bold text-black mb-4 text-center">Eco-Friendly Materials</h3>
            ...
            <div className="relative rounded-lg overflow-hidden shadow-sm min-h-[250px] group">
              ...
              <div className="absolute inset-0 bg-[#EED9C4]/70"></div>
              <div className="relative z-10 p-8 h-full flex flex-col">
                <h3 className="text-xl font-bold text-black mb-4 text-center">Responsible Manufacturing</h3>
                <div className="flex-1 flex items-center justify-center">
                  <p className="text-lg font-semibold text-black text-center">
            ...
            <div className="relative rounded-lg overflow-hidden shadow-sm min-h-[250px] group">
              ...
              <div className="absolute inset-0 bg-[#EED9C4]/70"></div>
              <div className="relative z-10 p-8 h-full flex flex-col">
                <h3 className="text-xl font-bold text-black mb-4 text-center">Mattress Recycling Program</h3>
                <div className="flex-1 flex items-center justify-center">
                  <p className="text-lg font-semibold text-black text-center">
